...
threshold_df.to_csv(
    RESULT_DIR / "v02_threshold_analysis.csv",
    index=False,
)

type_df.to_csv(
    RESULT_DIR / "v02_threshold_type_analysis.csv",
    index=False,
)
...
val[
    ...
    RESULT_DIR / "v02_threshold_predictions.csv",
    index=False,
)
...
print(
    RESULT_DIR / "threshold_analysis_.csv"
)

print(
    RESULT_DIR / "malicious_type_analysis.csv"
)
